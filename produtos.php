...
<body>
  ...
  <main>
    ...
    <div class="produtos">
      ...
      $sql = "SELECT id_produto, nome, imagem, preco, descricao FROM produtos";
      ...
      if ($resultado && $resultado->num_rows > 0) {
          while($row = $resultado->fetch_assoc()) {
              ...
              if (!empty($row["imagem"])) {
                  ...
                  echo "<img src='imagens/sem-imagem.jpg' alt='Sem imagem'>";
              }

              echo "<h3>" . htmlspecialchars($row["nome"]) . "</h3>";
              echo "<p>R$ " . number_format($row["preco"], 2, ',', '.') . "</p>";
              echo "<a href='produto_detalhe.php?id_produto=" . urlencode($row["id_produto"]) . "'>Ver mais</a>";
              echo "</div>";
          }
      } else {
